...
function showZone(store) {
  ...
  if (lat === null || lon === null) {
    clearZone();
    flash('err', 'Koordinat toko belum bener (' + store.lat + ', ' + store.lon + ') — perbaiki di Kelola Wajah.');
    return;
  }
  ...
  // pad 0.2: bulatan ngisi peta (sebelumnya 0.6 → zona cuma seperempat lebar peta, susah dibaca)
